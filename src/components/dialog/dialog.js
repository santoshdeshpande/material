 ...
 *     of the the dialog.
 *   - `openFrom` - `{string|DOMElement|object}`: The query selector, DOM element or the rect
 *     that the dialog will open from
 *   - `closeTo` - `{string|DOMElement|object}`: The query selector, DOM element or the rect
 *     that the dialog will close to
